...
export default function AITutorBubble() {
  ...
  useEffect(() => {
    if (open && messages.length === 0) {
      setMessages([{
        role: 'ai',
        text: 'Chào bạn, tôi là **Trợ lý Tư vấn** của trung tâm **Gia Sư Tin Học 24h**. Tôi có thể giúp bạn tìm hiểu về các khóa học, lộ trình phù hợp và thông tin đào tạo. Hãy chọn câu hỏi bên dưới hoặc đặt câu hỏi trực tiếp.'
      }])
    }
  }, [open])
